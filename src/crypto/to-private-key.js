export default (jwk) => {
  ...
  switch (jwk.kty) {
    case "RSA":
      switch (jwk.alg) {
        case "RSA-OAEP-256":
          return partial({ name: "RSA-OAEP", hash: "SHA-256" }, ["decrypt"]);
        case "RSA-OAEP-384":
          return partial({ name: "RSA-OAEP", hash: "SHA-384" }, ["decrypt"]);
        case "RSA-OAEP-512":
          return partial({ name: "RSA-OAEP", hash: "SHA-512" }, ["decrypt"]);
        default:
